...
public class GenericMethodInfo extends MethodInfo {
	...
	protected final void inferTypeArgs() {
		typeArgs = EquGenUtil.inferTypeArgs(origProcIns, getFormalTypes(), getType(), (JL5TypeSystem) origProcIns.typeSystem());
	}
	...
	private final void setOrigTypeInstance() {
		origProcIns = getOrigInstanceOf(getTypeInstance());
	}
}