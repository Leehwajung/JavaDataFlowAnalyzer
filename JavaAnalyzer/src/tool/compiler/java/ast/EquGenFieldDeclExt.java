...
public class EquGenFieldDeclExt extends EquGenExt {
	...
	public Node equGenLeave(EquGenerator v) {
		...
		if(e2 != null) {
			...
			//   2a. 스칼라 변수 또는 배열 변수의 Top Level의 MetaSetVariable의 데이터 플로우
			//   2a-1. e1(this)의 타입 C{Chi1}을 가져오고, E{Chi3} <: C{Chi1}.f 제약식을 추가 (non-static)
			...
			//   2a-2. E{Chi3} <: C.f 제약식을 추가 (static)
			else {
			...
			//   2b. 배열 변수인 경우, Top Level 아래의 MetaSetVariable의 데이터 플로우
